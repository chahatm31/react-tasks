        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                setWorkout({ ...workout, intensity: e.target.value })
              }
            />
          </div>
          ...
          <div key={goal.id} className="mb-4">
            ...
            <div className="flex items-center space-x-2">
              <Input
                ...
                onChange={(e) =>
                  onUpdateGoal(goal.id, parseFloat(e.target.value) || 0)
                }
              />
              <span>
            ...
            <div className="w-full bg-gray-200 rounded-full h-2.5 mt-2">
              <div
                ...
                style={{
                  width: `${((goal.progress || 0) / goal.target) * 100}%`,
                }}
              ></div>
            </div>
          </div>
              ...
              <Dialog>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Details of your workout on {workout.date}
                    </DialogDescription>
                  </DialogHeader>
...
const WorkoutSummary = ({ workouts }) => {
  ...
  const totalDuration = thisMonthWorkouts.reduce(
    ...
    thisMonthWorkouts.length > 0
      ? (
          thisMonthWorkouts.reduce(
            (sum, workout) => sum + parseInt(workout.intensity),
            0
...
const PersonalBests = ({ workouts }) => {
  ...
  useEffect(() => {
    ...
    setPersonalBests({
      ...
      highestIntensity: {
        intensity: highestIntensity.intensity,
        date: highestIntensity.date,
      },
    });
  }, [workouts]);
      ...
      <CardContent>
        <Tabs defaultValue="duration">
          ...
          <TabsContent value="duration">
            <div className="text-center py-4">
              <p className="text-3xl font-bold">
                {personalBests.longestWorkout.duration} minutes
              </p>
          ...
          <TabsContent value="intensity">
            <div className="text-center py-4">
              <p className="text-3xl font-bold">
                {personalBests.highestIntensity.intensity}/10
              </p>
              <p className="text-sm">
                on {personalBests.highestIntensity.date}
              </p>
            </div>
          </TabsContent>
        </Tabs>
